...
$githubRepositoryName = 'multiple-environments'
...
$testResourceGroup = New-AzResourceGroup -Name ToyWebsiteTest -Location northeurope
...
$productionResourceGroup = New-AzResourceGroup -Name ToyWebsiteProduction -Location northeurope
